...
%DIF DEL ..\original\Bianco2021.tex   Wed Sep 15 12:42:54 2021
%DIF ADD Bianco2021Rev1.tex           Sat Sep 18 13:13:45 2021
...
To validate our simulations, we compared musculoskeletal model outputs to experimental data. \DIFdelbegin \DIFdel{Joint moments (\nameref{S1_Fig}}%DIFDELCMD < %%%
\DIFdel{) }\DIFdelend \DIFaddbegin \DIFadd{We compared the value and timing of peak joint moments }\DIFaddend and joint angles \DIFdelbegin \DIFdel{(\nameref{S2_Fig}}%DIFDELCMD < %%%
...
\cite{Silder:2013}}%DIFAUXCMD
. The simulated }\DIFdelend \DIFaddbegin \DIFadd{to values previously reported in the literature. Simulated }\DIFaddend muscle activations were \DIFdelbegin \DIFdel{similar }\DIFdelend \DIFaddbegin \DIFadd{compared }\DIFaddend to normalized EMG \DIFdelbegin \DIFdel{with a few exceptions (\nameref{S3_Fig}}%DIFDELCMD < %%%
...
\cite{Samuels:1999}}%DIFAUXCMD
. The statistical tests were performed with R~\mbox{%DIFAUXCMD
\cite{CoreTeamR:2021, Bates:2015, Hothorn:2008}}%DIFAUXCMD
.
}
...
\DIFaddbegin \bibitem{Hicks:2015}
\DIFadd{Hicks JL, Uchida TK, Seth A, Rajagopal A, Delp SL.
  ...
  validation of musculoskeletal models and simulations of human movement}}\DIFadd{.
}\newblock \DIFadd{Journal of Biomechanical Engineering. 2015;137.
}\newblock \DIFadd{doi:}{\DIFadd{10.1115/1.4029304}}\DIFadd{.
}

\bibitem{SethPandy:2007}
\DIFadd{Seth A, Pandy MG.
}\newblock {\DIFadd{A Neuromusculoskeletal Tracking Method for Estimating Individual
  Muscle Forces in Human Movement}}\DIFadd{.
}\newblock \DIFadd{Journal of Biomechanics. 2007;40(2):356--366.
}\newblock \DIFadd{doi:}{\DIFadd{10.1016/j.jbiomech.2005.12.017}}\DIFadd{.
}

\bibitem{Bretz:2011}
{\DIFadd{Bretz, F  and Hothorn, T  and Westfall, P }}\DIFadd{.
}\newblock \DIFadd{Multiple comparisons using R.
}\newblock \DIFadd{Boca Raton, FL: CRC Press; 2011.
}

\bibitem{Samuels:1999}
{\DIFadd{Samuals, M L  and Witmer J A }}\DIFadd{.
}\newblock \DIFadd{Statistics for the Life Sciences.
}\newblock \DIFadd{3rd ed. Upper Saddle River, NJ: Pearson Education, Inc.; 1999.
}

\bibitem{CoreTeamR:2021}
{\DIFadd{R Core Team}}\DIFadd{. R: A Language and Environment for Statistical Computing; 2021.
}\newblock \DIFadd{Available from: }\url{https://www.R-project.org/}\DIFadd{.
}

\bibitem{Bates:2015}
\DIFadd{Bates D, M}{\DIFadd{\"a}}\DIFadd{chler M, Bolker B, Walker S.
...
}\newblock \DIFadd{doi:}{\DIFadd{10.18637/jss.v067.i01}}\DIFadd{.
}

\bibitem{Hothorn:2008}
\DIFadd{Hothorn T, Bretz F, Westfall P.
}\newblock \DIFadd{Simultaneous Inference in General Parametric Models.
}\newblock \DIFadd{Biometrical Journal. 2008;50(3):346--363.
}

\DIFaddend \bibitem{Silder:2013}
...
\newblock doi:{10.1109/TRO.2019.2913318\DIFaddbegin }\DIFadd{.
}

\bibitem{Browning:2007}
\DIFadd{Browning RC, Modica JR, Kram R, Goswami A.
}\newblock \DIFadd{The effects of adding mass to the legs on the energetics and
  biomechanics of walking.
}\newblock \DIFadd{Medicine \& Science in Sports \& Exercise. 2007;39(3):515--525.
}\newblock \DIFadd{doi:}{\DIFadd{10.1249/mss.0b013e31802b3562}\DIFaddend }.
