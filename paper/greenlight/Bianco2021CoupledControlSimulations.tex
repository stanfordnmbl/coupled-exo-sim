...
\begin{adjustwidth}{-1in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
    \centering
    \includegraphics[scale=0.5]{../../../figures/tableS4/tableS4.png}
    \caption*{{\bf S4 Table. Simulation-predicted unassisted metabolic rates.}
       This table shows the predicted gross average total metabolic rates for each subject. The columns represent the gait cycles used when testing single and multi-joint devices. These values underestimate experimental values typical of normal unassisted walking (4.0-4.3 W/kg,~\cite{Waters:1999}).}
\label{S4_Table}
\end{adjustwidth}
\end{figure}
...
\begin{adjustwidth}{-1in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
    \centering
    \includegraphics[scale=1.5]{../../../figures/figureS5/figureS5.png}
...
\begin{adjustwidth}{-1in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
    \centering
    \includegraphics[scale=0.5]{../../../figures/tableS6/tableS6.png}
...
\begin{adjustwidth}{-1in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
    \centering
    \includegraphics[scale=0.4]{../../../figures/tableS7/tableS7.png}
    \caption*{{\bf S7 Table. Subject-specific relative metabolic reductions.}
       This table shows subject-specific relative reductions in gross average total metabolic rate for each single and multi-joint device. All quantities are percent reductions in metabolic cost relative to unassisted walking.}
\label{S7_Table}
\end{adjustwidth}
\end{figure}
...
\begin{adjustwidth}{-1in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
    \centering
    \includegraphics[scale=0.7]{../../../figures/tableS8/tableS8.png}
    \caption*{{\bf S8 Table. Peak device moments and powers at each degree-of-freedom.}
...
\begin{adjustwidth}{-1in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
    \centering
    \includegraphics[scale=0.7]{../../../figures/figureS9/figureS9.png}
    \caption*{{\bf S9 Fig. Muscle activations for unassisted and assisted simulations.}
...
\bibliography{Bianco2021CoupledControlSimulations.bib}
